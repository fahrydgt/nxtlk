...
//            echo '<pre>';            print_r($this->get_invoice_info(1)); die;
            ...
            $html = '
                    <table>
                        <tr>
                            <td>Date: '.date('m/d/Y',$inv_dets['quoted_date']).'</td>
                            <td align="right"></td>
                        </tr>
                        <tr> 
                        ...
                        <tr>
                            <td>Insurance Company: '.$inv_dets['insurance_company'].'</td>
                            <td align="right">Vehicle No: '.$inv_dets['vehicle_number'].'</td>
                        </tr>
                        <tr>
                            <td>Customer: '.$inv_dets['customer_name'].'</td>
                            <td align="right">Make/Model: '.$inv_dets['vehicle_model'].'</td>
                        </tr>
                        <tr>
                            <td>Customer Contact Number: '.$inv_dets['phone'].'</td>
                            <td align="right">Chasis No: '.$inv_dets['chasis_no'].'</td>
                        </tr>
