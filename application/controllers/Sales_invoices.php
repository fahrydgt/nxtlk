...
//                                    'comments' => $inputs['memo'], 
            ...
            foreach ($inputs['inv_items'] as $inv_item){
                ...
                $data['item_stock_transection'][] = array(
                                                            'transection_type'=>2, //1 for Sales transection
...
//            echo '<pre>';            print_r($this->input->post()); die;
            ...
            $trans_data = $this->Sales_invoices_model->get_transections($inputs['id']);
            if(!empty($trans_data)){
...
//            echo '<pre>';            print_r($inputs); die;
            $data = $this->Sales_invoices_model->get_single_item($inputs['item_code'],$inputs['sales_type_id']); 
...
//                    echo '<pre>';                    print_r($invoice_desc); die;
           ...
           $data['inv_transection'] = $this->Sales_invoices_model->get_transections($inv_id);
