                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('location_name', set_value('location_name'), 'id="location_name" class="form-control" placeholder="Search by Reg Number"'); ?>

                                            </div>                                            
                                            <span class="help-block"><?php echo form_error('location_name');?></span>
                                        </div>
                                    </div> 
                            </div> 
