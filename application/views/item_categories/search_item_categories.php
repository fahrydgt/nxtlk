                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">                                            
                                            <div class="input-group">
                                                ...
                                                <?php echo form_input('cat_name', set_value('cat_name'), 'id="cat_name" class="form-control" placeholder="Search by Reg Number"'); ?>

                                            </div>                                            
                                            <span class="help-block"><?php echo form_error('cat_name');?></span>
                                        </div>
                                    </div> 
                            </div> 
