                                      ...
                                      <div class="tab-pane active" id="tab_1"> 
                                         ...
                                         <div class="col-md-6">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-md-3">
                                                    <img class="profile-user-img img-responsive img-circle" src="<?php echo base_url(ITEM_IMAGES.$result['id'].'/'.$result['image']); ?>" alt="User profile picture">
                                                </div>
                                            </div>
                                          ...
                                          <div  <?php echo $view;?> class="col-md-12">
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="col-md-9">    
                                                       <?php echo form_input('prices[purchasing][purchasing_amount]', set_value('prices[purchasing][purchasing_amount]'), 'id="prices[purchasing][purchasing_amount]" class="form-control" placeholder="Enter prices[purchasing][purchasing_amount] "'.$dis.' '.$o_dis.' '); ?>
                                              ...
                                              <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">    
                                                         <?php echo form_input('prices[purchasing][supplier_unit]', set_value('prices[purchasing][supplier_unit]'), 'id="prices[purchasing][supplier_unit]" class="form-control" placeholder="Enter prices[purchasing][supplier_unit] "'.$dis.' '.$o_dis.' '); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">    
                                                         <?php echo form_input('prices[purchasing][unit_conversation]', set_value('prices[purchasing][unit_conversation]'), 'id="prices[purchasing][unit_conversation]" class="form-control" placeholder="Enter prices[purchasing][unit_conversation] "'.$dis.' '.$o_dis.' '); ?>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">    
                                                         <?php echo form_input('prices[purchasing][description]', set_value('prices[purchasing][description]'), 'id="prices[purchasing][description]" class="form-control" placeholder="Enter prices[purchasing][description] "'.$dis.' '.$o_dis.' '); ?>
                                                    ...
                                                    <?php
                                                        foreach ($stock_status as $stock_loc){
                                                            echo '<tr>
                                                                        ...
                                                                        <td>'.($stock_loc['units_available'] - $stock_loc['units_on_order']).' '.$stock_loc['uom_name'].'</td>
