                        ...
                        <div class="row"> 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9">    
                                                        <?php echo form_input('reservation_no', set_value('reservation_no',(($result['person_type']==10)?$result['reservation_no']:$result['invoice_no'])), 'id="reservation_no" class="form-control" placeholder="Transection Typw"'.$dis.' '.$o_dis.' '); ?>
                                                        <span class="help-block"><?php echo form_error('reservation_no');?>&nbsp;</span>
                                                    </div> 
                                                </div>
                                            </div>
                                            <div class="col-md-6">
